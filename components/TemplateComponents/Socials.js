...
const Socials = ({ socials }) => {
  ...
  if (socials[0].bitbucket !== "") {
    bitbucketLink = (
      <a
        aria-label="bit bucket"
        href={socials[0].bitbucket}
        target="_blank"
        rel="noreferrer"
      >
  ...
  if (socials[0].deviantart !== "") {
    deviantartLink = (
      <a
        aria-label="deviant art"
        href={socials[0].deviantart}
        target="_blank"
        rel="noreferrer"
      >
  ...
  if (socials[0].wikipidea !== "") {
    wikipideaLink = (
      <a
        aria-label="wikipidea"
        href={socials[0].wikipidea}
        target="_blank"
        rel="noreferrer"
      >
